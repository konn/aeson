...
instance
  ...
  gToJSON opts targs =
    let gtj = gToJSON opts targs
     in liftToJSON (const False) gtj (listValue gtj) . unComp1
  {-# INLINE gToJSON #-}
...
instance
  ...
  -- instance to generically encode the innermost type:
  gToJSON opts targs =
    let gte = gToJSON opts targs
     in liftToEncoding (const False) gte (listEncoding gte) . unComp1
  {-# INLINE gToJSON #-}
...
instance
  ...
  taggedObject opts targs tagFieldName contentsFieldName =
    ...
    where
      tag =
        tagFieldName
          `pair` ( fromString (constructorTagModifier opts (conName (undefined :: t c a p))) ::
                    enc
                 )
      contents =
...
instance
  ( GToJSON' Value arity a
  , ConsToJSON Value arity a
  , Constructor c
  ) =>
  SumToJSON' TwoElemArray Value arity (C1 c a)
  where
...
dotNetTime (DotNetTime t) = secs ++ formatMillis t ++ ")/"
  where
    secs = formatTime defaultTimeLocale "/Date(%s" t
...
instance ToJSON CalendarDiffTime where
  toJSON (CalendarDiffTime m nt) =
    object
      [ "months" .= m
      , "time" .= nt
      ]
  toEncoding (CalendarDiffTime m nt) =
    E.pairs
      ("months" .= m <> "time" .= nt)

instance ToJSON CalendarDiffDays where
  toJSON (CalendarDiffDays m d) =
    object
      [ "months" .= m
      , "days" .= d
      ]
  toEncoding (CalendarDiffDays m d) =
    E.pairs
      ("months" .= m <> "days" .= d)
...
instance (ToJSON1 f, ToJSON1 g) => ToJSON1 (These1 f g) where
  ...
  liftToEncoding o tx tl (These1 a b) =
    E.pairs $
      pair "This" (liftToEncoding o tx tl a)
        `mappend` pair "That" (liftToEncoding o tx tl b)
...
instance (ToJSON a) => ToJSON2 ((,,) a) where
  ...
  liftToEncoding2 _ toB _ _ toC _ (a, b, c) =
    E.list
      id
      [ toEncoding a
      , toB b
...
instance (ToJSON a, ToJSON b) => ToJSON2 ((,,,) a b) where
  ...
  liftToEncoding2 _ toC _ _ toD _ (a, b, c, d) =
    E.list
      id
      [ toEncoding a
      , toEncoding b
...
instance (ToJSON a, ToJSON b, ToJSON c) => ToJSON2 ((,,,,) a b c) where
  ...
  liftToEncoding2 _ toD _ _ toE _ (a, b, c, d, e) =
    E.list
      id
      [ toEncoding a
      , toEncoding b
...
instance (ToJSON a, ToJSON b, ToJSON c, ToJSON d) => ToJSON2 ((,,,,,) a b c d) where
  ...
  liftToEncoding2 _ toE _ _ toF _ (a, b, c, d, e, f) =
    E.list
      id
      [ toEncoding a
      , toEncoding b
...
instance (ToJSON a, ToJSON b, ToJSON c, ToJSON d, ToJSON e) => ToJSON2 ((,,,,,,) a b c d e) where
  ...
  liftToEncoding2 _ toF _ _ toG _ (a, b, c, d, e, f, g) =
    E.list
      id
      [ toEncoding a
      , toEncoding b
...
instance (ToJSON a, ToJSON b, ToJSON c, ToJSON d, ToJSON e, ToJSON f) => ToJSON2 ((,,,,,,,) a b c d e f) where
  ...
  liftToEncoding2 _ toG _ _ toH _ (a, b, c, d, e, f, g, h) =
    E.list
      id
      [ toEncoding a
      , toEncoding b
...
instance (ToJSON a, ToJSON b, ToJSON c, ToJSON d, ToJSON e, ToJSON f, ToJSON g) => ToJSON2 ((,,,,,,,,) a b c d e f g) where
  ...
  liftToEncoding2 _ toH _ _ toI _ (a, b, c, d, e, f, g, h, i) =
    E.list
      id
      [ toEncoding a
      , toEncoding b
...
instance (ToJSON a, ToJSON b, ToJSON c, ToJSON d, ToJSON e, ToJSON f, ToJSON g, ToJSON h) => ToJSON2 ((,,,,,,,,,) a b c d e f g h) where
  ...
  liftToEncoding2 _ toI _ _ toJ _ (a, b, c, d, e, f, g, h, i, j) =
    E.list
      id
      [ toEncoding a
      , toEncoding b
...
instance (ToJSON a, ToJSON b, ToJSON c, ToJSON d, ToJSON e, ToJSON f, ToJSON g, ToJSON h, ToJSON i) => ToJSON2 ((,,,,,,,,,,) a b c d e f g h i) where
  ...
  liftToEncoding2 _ toJ _ _ toK _ (a, b, c, d, e, f, g, h, i, j, k) =
    E.list
      id
      [ toEncoding a
      , toEncoding b
...
instance (ToJSON a, ToJSON b, ToJSON c, ToJSON d, ToJSON e, ToJSON f, ToJSON g, ToJSON h, ToJSON i, ToJSON j) => ToJSON2 ((,,,,,,,,,,,) a b c d e f g h i j) where
  ...
  liftToEncoding2 _ toK _ _ toL _ (a, b, c, d, e, f, g, h, i, j, k, l) =
    E.list
      id
      [ toEncoding a
      , toEncoding b
...
instance (ToJSON a, ToJSON b, ToJSON c, ToJSON d, ToJSON e, ToJSON f, ToJSON g, ToJSON h, ToJSON i, ToJSON j, ToJSON k) => ToJSON2 ((,,,,,,,,,,,,) a b c d e f g h i j k) where
  ...
  liftToEncoding2 _ toL _ _ toM _ (a, b, c, d, e, f, g, h, i, j, k, l, m) =
    E.list
      id
      [ toEncoding a
      , toEncoding b
...
instance (ToJSON a, ToJSON b, ToJSON c, ToJSON d, ToJSON e, ToJSON f, ToJSON g, ToJSON h, ToJSON i, ToJSON j, ToJSON k, ToJSON l) => ToJSON2 ((,,,,,,,,,,,,,) a b c d e f g h i j k l) where
  ...
  liftToEncoding2 _ toM _ _ toN _ (a, b, c, d, e, f, g, h, i, j, k, l, m, n) =
    E.list
      id
      [ toEncoding a
      , toEncoding b
...
instance (ToJSON a, ToJSON b, ToJSON c, ToJSON d, ToJSON e, ToJSON f, ToJSON g, ToJSON h, ToJSON i, ToJSON j, ToJSON k, ToJSON l, ToJSON m) => ToJSON2 ((,,,,,,,,,,,,,,) a b c d e f g h i j k l m) where
  ...
  liftToEncoding2 _ toN _ _ toO _ (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) =
    E.list
      id
      [ toEncoding a
      , toEncoding b
